    ...
    <section>
      {records!.map((person, index) => (
        <div
          ...
          key={index}
          className="border mb-4 table-auto text-sm flex flex-row transition duration-150 hover:cursor-pointer hover:bg-green hover:text-basic-white hover:shadow-md p-4 dropIn opacity-0"
