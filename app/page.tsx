  ...
  return (
    <main className="w-100 flex flex-col items-center justify-between py-8">
      ...
      <p className="w-[80ch] pb-10">
        ...
        några dagar registrerande skapades en lista på över 400 rader och
      ...
      <p className="w-[80ch] pb-10">
        ...
        dokument från tiden mellan 1880-1930. Nicklas vill förmedla en känsla av
        att man bläddrar i en sådan passagerarlista och då blir kontakten med
        historian mer personlig. En lista rakt upp och ner hade aldrig varit
        lika intressant att använda, det tror inte Nicklas i alla fall.
      </p>
      <Link
